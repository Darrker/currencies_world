...
class CurrencyConverter extends React.Component {
  ...
  onFormSubmit = e => {
    ...
    if (!this.state.amountError) {
      ...
      this.setState({displayConvertResult: true});
    }
  ...
  swapChosenCurrencies = e => {
    ...
    this.setState({currencyFromLatestValue: this.state.currencyToLatestValue, currencyFrom: this.state.currencyTo, currencyToLatestValue: fromLatestValue, currencyTo: fromValue});
  }
  ...
  render() {
    return (
      ...
      <div className="currency-converter">
        <h3 className="currency-converter__title">Kalkulator walut:</h3>
        ...
        <form
          ...
          <div
            className="currency-converter__form-field currency-converter__form-field--amount">
            ...
            <input
              ...
              className={`currency-converter__form-field__input ${this.state.amountError
              ? `is-error`
              : ''} `}
              type="text"
              name="amount"
              id="amount"/> {this.state.amountError
              ? <span className="error">Niepoprawna wartość</span>
              : ''}
          </div>
          <div
            className="currency-converter__form-field currency-converter__form-field--from">
            ...
            <div className="currency-chooser-wrapper">
              ...
              <input
                className={`currency-converter__form-field__input `}
                onBlur={this.onBlurFrom}
                onChange={this.setCurrencyFrom}
                value={this.state.currencyFrom}
                onClick={this.onFocusFrom}
                type="text"
                name="from"
                id="from"/> {this.state.openCurrencyChooserForFrom
                ? <CurrencyChooser
                    externalInput={true}
                    externalInputValue={this.state.currencyFrom}
                    chosenCurrency={this.onChosenCurrencyFrom}
                    list={this.props.allCurrencies}/>
                : ''}
            </div>
          </div>

          <button
            className="currency-converter__field-swapper"
            onClick={this.swapChosenCurrencies}>
            <i className="fas fa-exchange-alt"></i>
          </button>
          <div
            className="currency-converter__form-field currency-converter__form-field--to">
            ...
            <div className="currency-chooser-wrapper">
              ...
              <input
                ...
                onClick={this.onFocusTo}
                type="text"
                name="to"
                id="tp"/> {this.state.openCurrencyChooserForTo
                ? <CurrencyChooser
                    externalInput={true}
                    externalInputValue={this.state.currencyTo}
                    chosenCurrency={this.onChosenCurrencyTo}
                    list={this.props.allCurrencies}/>
                : ''}
            </div>
        ...
        {this.state.displayConvertResult
          ? <div className="currency-converter__result">
              <button
                className="currency-converter__result__exit"
                onClick={this.exitCurrencyConverterResult}>X</button>
              <span className="currency-converter__result__title">
                Już obliczyliśmy!
              </span>
              <span className="currency-converter__result__from">
                {this.dataForConverterResult.amount} &nbsp;
                {this.dataForConverterResult.currencyFrom} to
              </span>

              <span className="currency-converter__result__to">
                {this.dataForConverterResult.calculetedValue}&nbsp;
                {this.dataForConverterResult.currencyTo}
              </span>
            </div>
